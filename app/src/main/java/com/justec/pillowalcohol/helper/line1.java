...
public class line1 extends SurfaceView implements SurfaceHolder.Callback , Runnable
{
    ...
    public line1(Context context , AttributeSet attrs)
    {
        super(context, attrs);
    ...
    private void drawView()
    {
        ...
        mPaint.setColor(res.getColor(R.color.blue_grey_800));
        drawAllXLine(canvas);
    ...
    private void drawText(String text , int x , int y , Canvas canvas)
    {
        ...
        p.setColor(res.getColor(R.color.red_300));
