...
import com.justec.common.convention.PlaceHolderView;
...
public abstract class BaseMainFragment extends SupportFragment {
    ...
    public boolean onBackPressedSupport() {
        if (System.currentTimeMillis() - TOUCH_TIME < WAIT_TIME) {
            ...
            //清楚界面ReceivceFragment_1,SearchReasultFragment_1数据
//            EventBusActivityScope.getDefault(_mActivity).postSticky(new DisConnectInstatntInfo());
