package com.justec.common.BottomNaviView;
 ...
 * @author abvatous
 * @name BleOperator
 * @class name：app.justec.com.common.widget.BottomNaviView
 * @class describe
 * @time 2018/4/25 0025 上午 9:19
 * @change
 * @chang time
 * @class describe
 */
public class BottomNavViewWithSelector extends BottomNavigationView {
    // used for animation
    ...
    private BottomNavViewWithSelectorOnPageChangeListener mPageChangeListener;
    ...
    public BottomNavViewWithSelector(Context context) {
        super(context);
//        init();
    }

    public BottomNavViewWithSelector(Context context, AttributeSet attrs) {
        super(context, attrs);
//        init();
    }

    public BottomNavViewWithSelector(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        System.out.println("mMenuView:" + mMenuView + " mButtons:" + mButtons + " mOnClickListener" + mOnClickListener);
    ...
    /**
     * This method will link the given ViewPager and this BottomNavViewWithSelector together so that
     ...
     */
    public void setupWithViewPager(final ViewPager viewPager, boolean smoothScroll) {
        if (mViewPager != null) {
        ...
        if (mPageChangeListener == null) {
            mPageChangeListener = new BottomNavViewWithSelectorOnPageChangeListener(this);
        }
     ...
     * necessary calls back to the provided {@link BottomNavViewWithSelector} so that the tab position is
     * kept in sync.
     * <p>
     * <p>This class stores the provided BottomNavViewWithSelector weakly, meaning that you can use
     * {@link ViewPager#addOnPageChangeListener(ViewPager.OnPageChangeListener)
     * addOnPageChangeListener(OnPageChangeListener)} without removing the listener and
     * not cause a leak.
     */
    private static class BottomNavViewWithSelectorOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<BottomNavViewWithSelector> mBnveRef;

        public BottomNavViewWithSelectorOnPageChangeListener(BottomNavViewWithSelector bnve) {
        ...
        public void onPageSelected(final int position) {
            final BottomNavViewWithSelector bnve = mBnveRef.get();
...
//            Log.d("onPageSelected", "--------- position " + position + " ------------");
    ...
    private static class MyOnNavigationItemSelectedListener implements OnNavigationItemSelectedListener {
        ...
        MyOnNavigationItemSelectedListener(ViewPager viewPager, BottomNavViewWithSelector bnve, boolean smoothScroll, OnNavigationItemSelectedListener listener) {
