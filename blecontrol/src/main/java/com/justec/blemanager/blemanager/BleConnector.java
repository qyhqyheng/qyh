...
import com.justec.blemanager.comm.BleWriteState;
import com.justec.blemanager.exception.GattException;
import com.justec.blemanager.exception.OtherException;
import com.justec.blemanager.exception.TimeOutException;
...
public class BleConnector {
                ...
                switch (msg.what) {
                    case BleMsg.MSG_CHA_NOTIFY_START: {
                        ...
                        if (notifyCallback != null)
                            BleLog.e("notifyCallback = "+notifyCallback);
    ...
    public void enableCharacteristicNotify(BleNotifyCallback bleNotifyCallback, String uuid_notify) {
        if (mCharacteristic != null
            ...
            Log.e("Jerry.Xiao","setCharacteristicNotification1 = "+ setCharacteristicNotification(mBluetoothGatt, mCharacteristic, true, bleNotifyCallback));
        } else {
    ...
    public boolean disableCharacteristicNotify() {
        if (mCharacteristic != null
                && (mCharacteristic.getProperties() | BluetoothGattCharacteristic.PROPERTY_NOTIFY) > 0) {
            Log.d("Jerry.Xiao","setCharacteristicNotification2 = "+ setCharacteristicNotification(mBluetoothGatt, mCharacteristic, false, null));
    ...
    private boolean setCharacteristicNotification(BluetoothGatt gatt,
        ...
        Log.e("Jerry.Xiao","setCharacteristicNotification3 = "+ success1);
    ...
    private boolean setCharacteristicIndication(BluetoothGatt gatt,
        ...
        boolean success1 = gatt.setCharacteristicNotification(characteristic, enable);
        Log.e("Jerry.Xiao","setCharacteristicNotification4 = "+ success1);
        if (!success1) {
            indicateMsgInit();
            if (bleIndicateCallback != null)
